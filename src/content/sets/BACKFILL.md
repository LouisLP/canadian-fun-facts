...
Every slide now renders **6 photos** in identical 5:4 frames (three per side
gutter). All 60 slides currently ship 4, so **120 images** are needed.

Drop new files into the `inbox/` folder of the relevant set. Anything in
`inbox/` is raw — an agent optimizes it to `.webp`, moves it up into the set
folder, and wires it into `index.ts` with alt text and a credit line.

Naming: `<subject>-<detail>.<ext>`, kebab-case, e.g. `syrup-evaporator-steam.jpg`.
Prefer landscape-ish sources; the 5:4 frame centre-crops, so keep the subject
away from the edges.
...
### Calling, zipping, computing — has 4, need 2
...
### Life-savers and peach baskets — has 4, need 2
...
### Sugar shack season — has 4, need 2
...
### The great syrup heist — has 4, need 2
...
### Leading men, made in Canada — has 4, need 2
...
### Canada runs the charts — has 4, need 2
...
### Famous in every field — has 4, need 2
...
### Joual of the crown — has 4, need 2
...
### Colour me Canadian — has 4, need 2
...
### Traditions worth freezing for — has 4, need 2
...
### Life at sixty below — has 4, need 2
...
### The sky puts on a show — has 4, need 2
...
### On unceded ground — has 4, need 2
...
### Spirit of the coast — has 4, need 2
...
_Travel: Gate Expectations_

### Landing on top — has 4, need 2
...
### Six ways to be late — has 4, need 2
...
### Mountains on the meter — has 4, need 2
...
### Going for gold in Vancouver — has 4, need 2
...
### Our game, on grass and on ice — has 4, need 2
...
## 2026-03-16-weird-laws

_Weird Laws: Mind the Fine Print_

### Nickel and dimed — has 4, need 2
...
_Coast to Coast to Coast: All 13 of Us_

### Peaks, prairie, and polar bears — has 4, need 2
...
### Where most of us live — has 4, need 2
...
### Where the tide runs the show — has 4, need 2
...
_Beavers: Nature's Construction Crew_

### Dam fine engineering — has 4, need 2
