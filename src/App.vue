...
const scatter = [
  { src: 'canada-map', top: '10%', left: '8%', size: '20vmin', tilt: '-6deg', phase: 0 },
  { src: 'beaver', top: '5%', left: '46%', size: '15vmin', tilt: '5deg', phase: 1 },
  { src: 'toronto', top: '14%', left: '84%', size: '22vmin', tilt: '-3deg', phase: 0 },
  { src: 'lake-louise', top: '36%', left: '18%', size: '19vmin', tilt: '7deg', phase: 1 },
  { src: 'loonie', top: '46%', left: '58%', size: '13vmin', tilt: '-8deg', phase: 0 },
  { src: 'hockey-player', top: '56%', left: '90%', size: '17vmin', tilt: '4deg', phase: 1 },
  { src: 'kayak', top: '72%', left: '10%', size: '18vmin', tilt: '-5deg', phase: 0 },
  { src: 'canadiana', top: '82%', left: '42%', size: '20vmin', tilt: '6deg', phase: 1 },
  { src: 'vancouver', top: '88%', left: '76%', size: '18vmin', tilt: '-4deg', phase: 0 },
  { src: 'vancouver-english-bay', top: '28%', left: '96%', size: '15vmin', tilt: '8deg', phase: 1 },
]
</script>
